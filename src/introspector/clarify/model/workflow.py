...
class WorkflowGenerator:
    def __init__(self):
        self.workflow_definition = {"nodes": [], "workflow_output": {}}
    ...
    def generate_workflow(self, dataset_ids):
        ...
        for dataset_id in dataset_ids:
            ...
            self.workflow_definition["workflow_output"]["outputs"].append(
                {"name": dataset_name}
            )
        ...
        for combo in combinations(dataset_ids, 2):
            ...
            join_node = {
                ...
                "inputs": {
                    "from_node": f"{dataset_combo[0].replace('-', '_')} Output Task"
                },
            }
